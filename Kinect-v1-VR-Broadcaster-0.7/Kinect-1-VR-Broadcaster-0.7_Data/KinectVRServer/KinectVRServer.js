...
HOST = getIPAddress();
// interneitt IP address
var PUBHOST = '79.118.5.147';
...
function UpdateBodyPart(id,jointName,posx,posy,posz,rotx,roty,rotz,rotw, infered){
	...
	if (body){
		...
		var joint = aliasFind(jointName,body.parts);
		if (joint){
...
this.parts.push (new Joint("FootLeft","15"));
this.parts.push (new Joint("AnkleLeft","14"));
this.parts.push (new Joint("KneeLeft","13"));
this.parts.push (new Joint("HipLeft","12"));

this.parts.push (new Joint("FootRight","19"));
this.parts.push (new Joint("AnkleRight","18"));
this.parts.push (new Joint("KneeRight","17"));
this.parts.push (new Joint("HipRight","16"));

this.parts.push (new Joint("HandTipLeft","none"));
this.parts.push (new Joint("ThumbLeft","none"));
this.parts.push (new Joint("HandLeft","7"));
this.parts.push (new Joint("WristLeft","6"));
this.parts.push (new Joint("ElbowLeft","5"));
this.parts.push (new Joint("ShoulderLeft","4"));

this.parts.push (new Joint("HandTipRight","none"));
this.parts.push (new Joint("ThumbRight","none"));
this.parts.push (new Joint("HandRight","11"));
this.parts.push (new Joint("WristRight","10"));
this.parts.push (new Joint("ElbowRight","9"));
this.parts.push (new Joint("ShoulderRight","8"));

this.parts.push (new Joint("SpineBase","0"));
this.parts.push (new Joint("SpineMid","1"));
this.parts.push (new Joint("SpineShoulder","2"));
this.parts.push (new Joint("Neck","3"));
this.parts.push (new Joint("Head", "none"));
